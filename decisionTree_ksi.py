...
try:
    ...
    num_transformer = Pipeline([
        ('imputer', SimpleImputer(strategy='median')),  # Impute with median for numeric columns
        ('scaler', StandardScaler())  # Scale numerical features
    ])

    cat_transformer = Pipeline([
        ('imputer', SimpleImputer(strategy='most_frequent')),  # Impute with most frequent for categorical columns
    ...
    grid_search_dt = GridSearchCV(estimator=pipe_dt, param_grid=param_grid_dt, scoring='accuracy', refit=True, verbose=3)
