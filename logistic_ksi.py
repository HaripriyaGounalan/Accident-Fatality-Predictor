...
try:
    ...
    param_grid_logreg = {
        'logreg__C': [0.01, 0.1, 1, 10, 100],  # Regularization strength for logistic regression
        'logreg__solver': ['liblinear', 'saga']  # Solvers for logistic regression
    }

    grid_search_logreg = GridSearchCV(estimator=pipe_logreg, param_grid=param_grid_logreg, scoring='accuracy', refit=True, verbose=3)
